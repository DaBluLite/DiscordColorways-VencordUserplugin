...
var yo = Re((hr) => {
  ...
  hr.encode = function (e) {
    if (0 <= e && e < xo.length) return xo[e];
...
var Co = Re((fr) => {
  ...
  fr.encode = function (t) {
    var r = "",
      n,
      i = Qa(t);
    do (n = i & vo), (i >>>= mr), i > 0 && (n |= So), (r += ko.encode(n));
    while (i > 0);
    return r;
  };
  fr.decode = function (t, r, n) {
    ...
    do {
      ...
      if (((l = ko.decode(t.charCodeAt(r++))), l === -1))
        throw new Error("Invalid base64 digit: " + t.charAt(r - 1));
      (u = !!(l & So)), (l &= vo), (o = o + (l << a)), (a += mr);
    } while (u);
    (n.value = Xa(o)), (n.rest = r);
  };
});
var Nt = Re((V) => {
  function $a(e, t, r) {
  ...
  function el(e) {
    ...
    return function (r) {
      ...
      var o = e(r);
      return t.unshift({ input: r, result: o }), t.length > Ja && t.pop(), o;
    };
  }
  var dr = el(function (t) {
    var r = t,
      n = at(t);
    if (n) {
      if (!n.path) return t;
    ...
    for (var i = V.isAbsolute(r), o = [], a = 0, u = 0; ; )
      if (((a = u), (u = r.indexOf("/", a)), u === -1)) {
        o.push(r.slice(a));
        break;
      } else for (o.push(r.slice(a, u)); u < r.length && r[u] === "/"; ) u++;
    for (var l, s = 0, u = o.length - 1; u >= 0; u--)
      (l = o[u]),
        l === "."
          ? o.splice(u, 1)
          : l === ".."
          ? s++
          : s > 0 &&
            (l === "" ? (o.splice(u + 1, s), (s = 0)) : (o.splice(u, 2), s--));
    return (
      (r = o.join("/")),
      r === "" && (r = i ? "/" : "."),
      n ? ((n.path = r), He(n)) : r
  ...
  function Ao(e, t) {
    ...
    if ((n && (e = n.path || "/"), r && !r.scheme))
      return n && (r.scheme = n.scheme), He(r);
    if (r || t.match(Za)) return t;
    if (n && !n.host && !n.path) return (n.host = t), He(n);
    var i = t.charAt(0) === "/" ? t : dr(e.replace(/\/+$/, "") + "/" + t);
    return n ? ((n.path = i), He(n)) : i;
  }
  V.join = Ao;
  V.isAbsolute = function (e) {
    return e.charAt(0) === "/" || To.test(e);
  };
  function tl(e, t) {
    e === "" && (e = "."), (e = e.replace(/\/$/, ""));
  ...
  V.toSetString = Lo ? Eo : rl;
  function nl(e) {
    return zo(e) ? e.slice(1) : e;
  }
  V.fromSetString = Lo ? Eo : nl;
  function zo(e) {
    if (!e) return !1;
    var t = e.length;
    if (
  ...
  V.compareByOriginalPositions = il;
  function ol(e, t, r) {
    var n;
    return (
  ...
  V.compareByOriginalPositionsNoSource = ol;
  function sl(e, t, r) {
    var n = e.generatedLine - t.generatedLine;
    return n !== 0 ||
      ((n = e.generatedColumn - t.generatedColumn), n !== 0 || r) ||
      ((n = ye(e.source, t.source)), n !== 0) ||
      ((n = e.originalLine - t.originalLine), n !== 0) ||
      ((n = e.originalColumn - t.originalColumn), n !== 0)
      ? n
      : ye(e.name, t.name);
  }
  V.compareByGeneratedPositionsDeflated = sl;
  function al(e, t, r) {
  ...
  V.compareByGeneratedPositionsDeflatedNoLine = al;
  function ye(e, t) {
  ...
  function ll(e, t) {
    ...
    return r !== 0 ||
      ...
      ((r = ye(e.source, t.source)), r !== 0) ||
      ((r = e.originalLine - t.originalLine), r !== 0) ||
      ((r = e.originalColumn - t.originalColumn), r !== 0)
      ? r
      : ye(e.name, t.name);
  }
  V.compareByGeneratedPositionsInflated = ll;
  function cl(e) {
    return JSON.parse(e.replace(/^\)]}'[^\n]*\n/, ""));
  }
  V.parseSourceMapInput = cl;
  function ul(e, t, r) {
    if (
      ((t = t || ""),
...
var Io = Re((Po) => {
  var gr = Nt(),
    ...
    De = typeof Map < "u";
  function ke() {
    (this._array = []), (this._set = De ? new Map() : Object.create(null));
  }
  ...
  ke.prototype.size = function () {
    return De ? this._set.size : Object.getOwnPropertyNames(this._set).length;
  };
  ke.prototype.add = function (t, r) {
    var n = De ? t : gr.toSetString(t),
      i = De ? this.has(t) : br.call(this._set, n),
      o = this._array.length;
    (!i || r) && this._array.push(t),
      i || (De ? this._set.set(t, o) : (this._set[n] = o));
  };
  ke.prototype.has = function (t) {
    if (De) return this._set.has(t);
...
var Oo = Re((No) => {
  ...
  function pl(e, t) {
    ...
    return (
      n > r ||
      (n == r && o >= i) ||
      Do.compareByGeneratedPositionsInflated(e, t) <= 0
    );
  }
  function Ot() {
    (this._array = []),
  ...
  Ot.prototype.unsortedForEach = function (t, r) {
...
var Ro = Re((Fo) => {
  ...
  function ie(e) {
    e || (e = {}),
      ...
      (this._sources = new Ft()),
      (this._names = new Ft()),
      (this._mappings = new hl()),
      (this._sourcesContents = null);
  }
  ie.prototype._version = 3;
  ie.fromSourceMap = function (t) {
    var r = t.sourceRoot,
      n = new ie({ file: t.file, sourceRoot: r });
    return (
      t.eachMapping(function (i) {
        ...
        i.source != null &&
          ((o.source = i.source),
          r != null && (o.source = U.relative(r, o.source)),
  ...
  ie.prototype.addMapping = function (t) {
    var r = U.getArg(t, "generated"),
      n = U.getArg(t, "original", null),
      i = U.getArg(t, "source", null),
      o = U.getArg(t, "name", null);
  ...
  ie.prototype.setSourceContent = function (t, r) {
    var n = t;
    this._sourceRoot != null && (n = U.relative(this._sourceRoot, n)),
      r != null
        ? (this._sourcesContents ||
            (this._sourcesContents = Object.create(null)),
          (this._sourcesContents[U.toSetString(n)] = r))
        : this._sourcesContents &&
          (delete this._sourcesContents[U.toSetString(n)],
          Object.keys(this._sourcesContents).length === 0 &&
            (this._sourcesContents = null));
  };
  ie.prototype.applySourceMap = function (t, r, n) {
    var i = r;
    if (r == null) {
      if (t.file == null)
        throw new Error(
    ...
    this._mappings.unsortedForEach(function (l) {
      if (l.source === i && l.originalLine != null) {
        ...
        s.source != null &&
          ((l.source = s.source),
          n != null && (l.source = U.join(n, l.source)),
          o != null && (l.source = U.relative(o, l.source)),
          (l.originalLine = s.line),
          (l.originalColumn = s.column),
          s.name != null && (l.name = s.name));
      }
      var c = l.source;
      ...
      (this._sources = a),
      (this._names = u),
      t.sources.forEach(function (l) {
        var s = t.sourceContentFor(l);
        s != null &&
          (n != null && (l = U.join(n, l)),
          o != null && (l = U.relative(o, l)),
          this.setSourceContent(l, s));
      }, this);
  };
  ie.prototype._validateMapping = function (t, r, n, i) {
  ...
  ie.prototype._serializeMappings = function () {
    for (
      var t = 0,
        r = 1,
        n = 0,
      ...
      if (((s = m[f]), (l = ""), s.generatedLine !== r))
        for (t = 0; s.generatedLine !== r; ) (l += ";"), r++;
      else if (f > 0) {
        if (!U.compareByGeneratedPositionsInflated(s, m[f - 1])) continue;
        l += ",";
      }
      (l += lt.encode(s.generatedColumn - t)),
        (t = s.generatedColumn),
        s.source != null &&
          ((h = this._sources.indexOf(s.source)),
          (l += lt.encode(h - a)),
          (a = h),
          (l += lt.encode(s.originalLine - 1 - i)),
          (i = s.originalLine - 1),
          (l += lt.encode(s.originalColumn - n)),
          (n = s.originalColumn),
          s.name != null &&
            ((c = this._names.indexOf(s.name)),
            (l += lt.encode(c - o)),
            (o = c))),
        (u += l);
    }
  ...
  ie.prototype._generateSourcesContent = function (t, r) {
    return t.map(function (n) {
      if (!this._sourcesContents) return null;
      r != null && (n = U.relative(r, n));
      var i = U.toSetString(n);
...
function Tt(e) {
  return Wa(e) || ja(e) || e === 95;
}
function Me(e) {
  return Tt(e) || j(e) || e === 45;
}
function qa(e) {
...
for (let e = 0; e < ir.length; e++)
  ir[e] =
    (pe(e) && rt) || (j(e) && or) || (Tt(e) && zt) || (qa(e) && sr) || e || Ua;
function Pt(e) {
  return e < 128 ? ir[e] : zt;
}
function _e(e, t) {
  return t < e.length ? e.charCodeAt(t) : 0;
}
function It(e, t, r) {
  return r === 13 && _e(e, t + 1) === 10 ? 2 : 1;
}
function be(e, t, r) {
  let n = e.charCodeAt(t);
  return At(n) && (n = n | 32), n === r;
}
function xe(e, t, r, n) {
...
function ae(e, t) {
  if (((t += 2), te(_e(e, t - 1)))) {
    for (let n = Math.min(e.length, t + 5); t < n && te(_e(e, t)); t++);
    let r = _e(e, t);
    pe(r) && (t += It(e, t, r));
  }
  return t;
...
function ze(e, t) {
  ...
  if (
    ...
    j(r) && ((t = ar(e, t + 1)), (r = e.charCodeAt(t))),
    r === 46 && j(e.charCodeAt(t + 1)) && ((t += 2), (t = ar(e, t))),
    be(e, t, 101))
  ) {
    let n = 0;
    (r = e.charCodeAt(t + 1)),
...
function ao(e) {
  let t = e.source,
    r = t.length,
    n = t.length > 0 ? Et(t.charCodeAt(0)) : 0,
    i = qe(e.lines, r),
    o = qe(e.columns, r),
    a = e.startLine,
    u = e.startColumn;
  ...
  (i[r] = a), (o[r] = u), (e.lines = i), (e.columns = o), (e.computed = !0);
}
var ot = class {
  constructor(t, r, n, i) {
...
var st = class {
  ...
  setSource(t = "", r = () => {}) {
    t = String(t || "");
    let n = t.length,
      i = qe(this.offsetAndType, t.length + 1),
      o = qe(this.balance, t.length + 1),
      a = 0,
      u = -1,
      l = 0,
      s = t.length;
    (this.offsetAndType = null),
      ...
      r(t, (c, h, m) => {
        let f = a++;
        if (
          ((i[f] = (c << me) | m), u === -1 && (u = h), (o[f] = s), c === l)
        ) {
          let w = o[s];
          (o[s] = f), (s = w), (l = Pe[i[w] >> me]);
        } else lo(c) && ((s = f), (l = Pe[c]));
      }),
      (i[a] = (0 << me) | n),
      (o[a] = a);
    for (let c = 0; c < a; c++) {
    ...
    (this.source = t),
      (this.firstCharOffset = u === -1 ? 0 : u),
      (this.tokenCount = a),
      (this.offsetAndType = i),
      (this.balance = o),
      this.reset(),
      this.next();
  }
  lookupType(t) {
    return (
      (t += this.tokenIndex),
      t < this.tokenCount ? this.offsetAndType[t] >> me : 0
    );
  }
  lookupTypeNonSC(t) {
  ...
  lookupOffset(t) {
    return (
      (t += this.tokenIndex),
      t < this.tokenCount ? this.offsetAndType[t - 1] & he : this.source.length
    );
  }
  lookupOffsetNonSC(t) {
    for (let r = this.tokenIndex; r < this.tokenCount; r++) {
  ...
  getTokenStart(t) {
    return t === this.tokenIndex
      ...
      ? t < this.tokenCount
        ? this.offsetAndType[t - 1] & he
        : this.offsetAndType[this.tokenCount] & he
  ...
  skip(t) {
    ...
    r < this.tokenCount
      ? ((this.tokenIndex = r),
        (this.tokenStart = this.offsetAndType[r - 1] & he),
  ...
  skipUntilBalanced(t, r) {
    ...
    e: for (; n < this.tokenCount; n++) {
      ...
      switch (
        ((o = n > 0 ? this.offsetAndType[n - 1] & he : this.firstCharOffset),
        r(this.source.charCodeAt(o)))
      ) {
        case 1:
          break e;
        case 2:
          ...
          break e;
        default:
          lo(this.offsetAndType[n] >> me) && (n = i);
      }
    }
...
function Se(e, t) {
  ...
  function n() {
    if (((s = ze(e, s)), Be(r(s), r(s + 1), r(s + 2)))) {
      (c = 12), (s = it(e, s));
      return;
    }
    if (r(s) === 37) {
  ...
  function i() {
    let h = s;
    if (((s = it(e, s)), xe(e, h, s, "url") && r(s) === 40)) {
      if (((s = nt(e, s + 1)), r(s) === 34 || r(s) === 39)) {
        (c = 2), (s = h + 4);
        return;
      }
      a();
  ...
  function o(h) {
    for (h || (h = r(s++)), c = 5; s < e.length; s++) {
      let m = e.charCodeAt(s);
      switch (Pt(m)) {
        case h:
          s++;
          return;
        ...
        case 92:
          ...
          let f = r(s + 1);
          tt(f) ? (s += It(e, s + 1, f)) : $(m, f) && (s = ae(e, s) - 1);
          break;
      }
    }
  }
  function a() {
    for (c = 7, s = nt(e, s); s < e.length; s++) {
    ...
    *[Symbol.iterator]() {
    ...
    reduce(t, r, n = this) {
      let i = this.allocateCursor(null, this.head),
        ...
        a;
      for (; i.next !== null; )
        (a = i.next), (i.next = a.next), (o = t.call(n, o, a.data, a, this));
    ...
    reduceRight(t, r, n = this) {
      let i = this.allocateCursor(this.tail, null),
        ...
        a;
      for (; i.prev !== null; )
        (a = i.prev), (i.prev = a.prev), (o = t.call(n, o, a.data, a, this));
      return this.releaseCursor(), o;
    }
    some(t, r = this) {
    ...
    map(t, r = this) {
      ...
      for (let i = this.head; i !== null; i = i.next)
        n.appendData(t.call(r, i.data, i, this));
      return n;
    }
    filter(t, r = this) {
      let n = new e();
      for (let i = this.head; i !== null; i = i.next)
        t.call(r, i.data, i, this) && n.appendData(i.data);
      return n;
    }
...
var lr = 100,
  co = 60,
  uo = "    ";
function po({ source: e, line: t, column: r, baseLine: n, baseColumn: i }, o) {
  function a(w, ee) {
    return s
      .slice(w, ee)
      .map((G, C) => String(w + C + 1).padStart(m) + " |" + G).join(`
`);
  }
  let u = `
`.repeat(Math.max(n - 1, 0)),
    ...
    s = (u + l + e).split(/\r\n?|\n|\f/),
    c = Math.max(1, t - o) - 1,
    h = Math.min(t + o, s.length + 1),
    m = Math.max(4, String(h).length) + 1,
    f = 0;
  (r +=
    (uo.length - 1) * (s[t - 1].substr(0, r - 1).match(/\t/g) || []).length),
    r > lr && ((f = r - co + 3), (r = co - 2));
  for (let w = c; w <= h; w++)
    w >= 0 &&
      w < s.length &&
      ((s[w] = s[w].replace(/\t/g, uo)),
      (s[w] =
        (f > 0 && s[w].length > f ? "\u2026" : "") +
        s[w].substr(f, lr - 2) +
        (s[w].length > f + lr - 1 ? "\u2026" : "")));
  return [a(c, t), new Array(r + m + 2).join("-") + "^", a(t, h)]
    .filter(Boolean)
    .join(
      `
`
...
function cr(e, t, r, n, i, o = 1, a = 1) {
  return Object.assign(Ie("SyntaxError", e), {
    source: t,
    offset: r,
    line: n,
    column: i,
    sourceFragment(l) {
      return po(
        { source: t, line: n, column: i, baseLine: o, baseColumn: a },
        isNaN(l) ? 0 : l
      );
    },
    get formattedMessage() {
      return (
        `Parse error: ${e}
` + po({ source: t, line: n, column: i, baseLine: o, baseColumn: a }, 2)
      );
    },
  });
}
function ho(e) {
  ...
  for (; !this.eof; ) {
    ...
    if (i === void 0) break;
    r && (e.onWhiteSpace && e.onWhiteSpace.call(this, i, t, n), (r = !1)),
      t.push(i);
  }
...
function Va(e) {
  ...
  for (let [r, n] of Object.entries(e.parseContext))
    switch (typeof n) {
      case "function":
        t.context[r] = n;
        break;
  ...
  let t = "",
    ...
    u = Object.assign(new st(), Va(e || {}), {
      ...
      consumeUntilLeftCurlyBracketOrSemicolon(s) {
        return s === fo || s === ur ? 1 : 0;
      },
      consumeUntilExclamationMarkOrSemicolon(s) {
        return s === Ga || s === ur ? 1 : 0;
      },
      ...
      lookupNonWSType(s) {
        let c;
        do if (((c = this.lookupType(s++)), c !== 13 && c !== 25)) return c;
        while (c !== go);
        return go;
      },
      charCodeAt(s) {
      ...
      consumeNumber(s) {
        let c = t.substring(this.tokenStart, ze(t, this.tokenStart));
        return this.eat(s), c;
      },
      eat(s) {
        if (this.tokenType !== s) {
          ...
          switch (s) {
            case 1:
              this.tokenType === 2 || this.tokenType === 7
                ? ((m = this.tokenEnd - 1),
                  (h = "Identifier is expected but function found"))
                : (h = "Identifier is expected");
              break;
            case 4:
              this.isDelim(Ya) && (this.next(), m++, (h = "Name is expected"));
              break;
            case 11:
              this.tokenType === 10 &&
                ((m = this.tokenEnd), (h = "Percent sign is expected"));
              break;
          }
          this.error(h, m);
        }
      ...
      getLocation(s, c) {
        return n ? a.getLocationRange(s, c, r) : null;
      },
      getLocationFromList(s) {
        if (n) {
          let c = this.getFirstListNode(s),
            h = this.getLastListNode(s);
      ...
      error(s, c) {
        let h =
          typeof c < "u" && c < t.length
            ? a.getLocation(c)
            : this.eof
            ? a.getLocation(io(t, t.length - 1))
  ...
  return Object.assign(
    function (s, c) {
      (t = s),
        (c = c || {}),
        u.setSource(t, Se),
        a.setSource(t, c.offset, c.line, c.column),
        (r = c.filename || "<unknown>"),
        (n = !!c.positions),
        (i = typeof c.onParseError == "function" ? c.onParseError : mo),
        (o = !1),
        (u.parseAtrulePrelude =
          "parseAtrulePrelude" in c ? !!c.parseAtrulePrelude : !0),
        (u.parseRulePrelude =
          "parseRulePrelude" in c ? !!c.parseRulePrelude : !0),
        (u.parseValue = "parseValue" in c ? !!c.parseValue : !0),
        (u.parseCustomProperty =
          "parseCustomProperty" in c ? !!c.parseCustomProperty : !1);
      let { context: h = "default", onComment: m } = c;
      if (!(h in u.context)) throw new Error("Unknown context `" + h + "`");
      typeof m == "function" &&
        u.forEachToken((w, ee, G) => {
          if (w === 25) {
            let C = u.getLocation(ee, G),
              M = xe(t, G - 2, G, "*/")
                ? t.slice(ee + 2, G - 2)
                : t.slice(ee + 2, G);
            m(M, C);
...
var Bo = Ba(Ro(), 1),
  Mo = new Set(["Atrule", "Selector", "Declaration"]);
function _o(e) {
  let t = new Bo.SourceMapGenerator(),
    r = { line: 1, column: 0 },
    n = { line: 0, column: 0 },
    i = { line: 1, column: 0 },
    o = { generated: i },
    ...
    s = e.node;
  e.node = function (m) {
    if (m.loc && m.loc.start && Mo.has(m.type)) {
      let f = m.loc.start.line,
        w = m.loc.start.column - 1;
      (n.line !== f || n.column !== w) &&
        ((n.line = f),
        (n.column = w),
        (r.line = a),
        ...
        l &&
          ((l = !1),
          (r.line !== i.line || r.column !== i.column) && t.addMapping(o)),
        (l = !0),
        t.addMapping({ source: m.loc.source, original: n, generated: r }));
    }
    s.call(this, m), l && Mo.has(m.type) && ((i.line = a), (i.column = u));
  };
  let c = e.emit;
  e.emit = function (m, f, w) {
    for (let ee = 0; ee < m.length; ee++)
      m.charCodeAt(ee) === 10 ? (a++, (u = 0)) : u++;
    c(m, f, w);
  };
  let h = e.result;
  return (
...
function jo(e) {
  ...
  return function (r, n, i) {
    let o = xr(n, i),
      a = i.charCodeAt(0);
    return (
      ((a === fl && n !== 1 && n !== 2 && n !== 15) || a === ml
        ? t.has((r << 16) | (a << 8))
        : t.has((r << 16) | o)) && this.emit(" ", 13, !0),
      o
    );
  };
}
...
function qo(e) {
  let t = new Map();
  for (let [r, n] of Object.entries(e.node))
...
`,
    ...
    n &&
      ...
      n.sourceMap && (a = _o(a)),
      n.mode in Rt && (a.tokenBefore = Rt[n.mode]));
    let u = {
      node: (l) => a.node(l),
      children: xl,
    ...
    fromPlainObject(t) {
      return (
        e(t, {
          enter(r) {
            r.children &&
              !(r.children instanceof Z) &&
              (r.children = new Z().fromArray(r.children));
          },
        }),
        t
      );
...
function kl(e, t) {
  let r = t.structure,
    n = [];
  for (let i in r) {
    if (kr.call(r, i) === !1) continue;
    let o = r[i],
      a = { name: i, type: !1, nullable: !1 };
    Array.isArray(o) || (o = [o]);
    for (let u of o)
      u === null
        ? (a.nullable = !0)
...
function Vo(e) {
  ...
  for (let s in t)
    kr.call(t, s) &&
      t[s] !== null &&
      ((r[s] = Yo(t[s], !1)), (n[s] = Yo(t[s], !0)));
  let a = Ko(r),
    u = Ko(n),
    l = function (s, c) {
      function h(C, M, ve) {
        let O = m.call(G, C, M, ve);
        return O === i
          ? !0
          : O === o
          ? !1
          : !!(
              (w.hasOwnProperty(C.type) && w[C.type](C, G, h, ee)) ||
              f.call(G, C, M, ve) === i
            );
      }
      let m = ct,
      ...
      if (typeof c == "function") m = c;
        ...
        c &&
        ((m = Ho(c.enter)), (f = Ho(c.leave)), c.reverse && (w = n), c.visit)
      ) {
        if (a.hasOwnProperty(c.visit)) w = c.reverse ? u[c.visit] : a[c.visit];
  ...
  return (
    ...
    (l.find = function (s, c) {
      ...
      return (
        l(s, function (m, f, w) {
          if (c.call(this, m, f, w)) return (h = m), i;
        }),
        h
      );
    }),
...
function Tl(e, t, r, n) {
  let i = e.combinator === " " || n ? e.combinator : " " + e.combinator + " ",
    o = e.terms.map((a) => Mt(a, t, r, n)).join(i);
  return e.explicit || r
    ? (n || o[0] === "," ? "[" : "[ ") + o + (n ? "]" : " ]")
    : o;
}
function Mt(e, t, r, n) {
  ...
  switch (e.type) {
    case "Group":
      ...
      break;
    case "Multiplier":
      return Mt(e.term, t, r, n) + t(Sl(e), e);
    case "Boolean":
      i = "<boolean-expr[" + Mt(e.term, t, r, n) + "]>";
      break;
    case "Type":
...
var Qo = { offset: 0, line: 1, column: 1 };
function Al(e, t) {
  let r = e.tokens,
    n = e.longestMatch,
  ...
  for (let m = 0; m < r.length; m++) {
    let f = r[m].value;
    m === n && ((u = f.length), (a = s.length)),
      o !== null && r[m].node === o && (m <= n ? l++ : (l = 0)),
      (s += f);
  }
  return (
    n === r.length || l > 1
      ? ((c = Bt(o || t, "end") || ut(Qo, s)), (h = ut(c)))
      : ((c = Bt(o, "start") || ut(Bt(t, "start") || Qo, s.slice(0, a))),
        (h = Bt(o, "end") || ut(c, s.substr(a, u)))),
    { css: s, mismatchOffset: a, mismatchLength: u, start: c, end: h }
  );
}
function Bt(e, t) {
  let r = e && e.loc && e.loc[t];
  return r ? ("line" in r ? ut(r) : r) : null;
}
function ut({ offset: e, line: t, column: r }, n) {
  let i = { offset: e, line: t, column: r };
  if (n) {
    let o = n.split(/\n|\r\n?|\f/);
    (i.offset += n.length),
      (i.line += o.length - 1),
      (i.column = o.length === 1 ? i.column + n.length : o.pop().length + 1);
  }
  return i;
}
var Ge = function (e, t) {
    let r = Ie("SyntaxReferenceError", e + (t ? " `" + t + "`" : ""));
    return (r.reference = t), r;
  },
  Xo = function (e, t, r, n) {
    let i = Ie("SyntaxMatchError", e),
      {
        css: o,
        mismatchOffset: a,
        mismatchLength: u,
...
function qt(e, t) {
  return (
    (t = t || 0),
    e.length - t >= 2 && e.charCodeAt(t) === Wt && e.charCodeAt(t + 1) === Wt
  );
}
function vr(e, t) {
  if (
    ((t = t || 0),
    e.length - t >= 3 && e.charCodeAt(t) === Wt && e.charCodeAt(t + 1) !== Wt)
  ) {
    let r = e.indexOf("-", t + 2);
...
var Ke = ["initial", "inherit", "unset", "revert", "revert-layer"];
var ht = 43,
  fe = 45,
  Sr = 110,
  Ve = !0,
...
function Ar(e, t) {
  let r = 0;
  if (!e) return 0;
  if (e.type === 10) return Ce(e, 0, Pl, r);
  if (e.type === 1 && e.value.charCodeAt(0) === fe) {
    if (!be(e.value, 1, Sr)) return 0;
    switch (e.value.length) {
      case 2:
        return Cr(t(++r), r, t);
      case 3:
        return e.value.charCodeAt(2) !== fe
          ? 0
          : ((r = pt(t(++r), r, t)), (e = t(r)), Ce(e, 0, Ve, r));
      default:
        return e.value.charCodeAt(2) !== fe ? 0 : Ce(e, 3, Ve, r);
    }
  } else if (e.type === 1 || (Tr(e, ht) && t(r + 1).type === 1)) {
    if ((e.type !== 1 && (e = t(++r)), e === null || !be(e.value, 0, Sr)))
      return 0;
    switch (e.value.length) {
      case 1:
        return Cr(t(++r), r, t);
      case 2:
        return e.value.charCodeAt(1) !== fe
          ? 0
          : ((r = pt(t(++r), r, t)), (e = t(r)), Ce(e, 0, Ve, r));
      default:
        return e.value.charCodeAt(1) !== fe ? 0 : Ce(e, 2, Ve, r);
    }
  } else if (e.type === 12) {
    let n = e.value.charCodeAt(0),
      i = n === ht || n === fe ? 1 : 0,
      o = i;
    for (; o < e.value.length && j(e.value.charCodeAt(o)); o++);
    return o === i || !be(e.value, o, Sr)
      ? 0
      : o + 1 === e.value.length
      ? Cr(t(++r), r, t)
      : e.value.charCodeAt(o + 1) !== fe
      ? 0
      : o + 2 === e.value.length
      ? ((r = pt(t(++r), r, t)), (e = t(r)), Ce(e, 0, Ve, r))
      : Ce(e, o + 2, Ve, r);
...
function mt(e, t, r) {
  ...
  for (let i = t; i < e.value.length; i++) {
    ...
    if (o === $o && r && n !== 0) return mt(e, t + n + 1, !1), 6;
...
function Er(e, t) {
  ...
  return e.type === 12 ? Ut(mt(e, 1, !0), ++r, t) : 0;
}
...
function es(e, t) {
  for (let r = 0; r < t.length; r++) if (Jo(e, t[r])) return !0;
  return !1;
}
function ts(e, t) {
  return t !== e.length - 2 ? !1 : le(e, t) === 92 && j(le(e, t + 1));
}
function Ht(e, t, r) {
  if (e && e.type === "Range") {
...
function Rl(e) {
  ...
  return es(t, Ke) || Jo(t, "default") ? 0 : 1;
}
function rs(e) {
  return e === null ||
    e.type !== 1 ||
...
function Ml(e) {
  return !rs(e) || e.value === "--" ? 0 : 1;
}
function Bl(e) {
  if (e === null || e.type !== 4) return 0;
  let t = e.value.length;
  if (t !== 4 && t !== 5 && t !== 7 && t !== 9) return 0;
  for (let r = 1; r < t; r++) if (!te(le(e.value, r))) return 0;
  return 1;
}
function _l(e) {
  return e === null ||
    e.type !== 4 ||
    !Be(le(e.value, 1), le(e.value, 2), le(e.value, 3))
    ? 0
    : 1;
}
function Wl(e, t) {
      ...
      if (e !== null) {
        let o = t.value.indexOf("\\", i),
          a =
            o === -1 || !ts(t.value, o)
              ? t.value.substr(i)
              : t.value.substring(i, o);
        if (e.has(a.toLowerCase()) === !1) return 0;
      }
      return Ht(n, t.value, i) ? 0 : 1;
    }
  );
}
function ql(e, t, r) {
  return e === null || e.type !== 11 || Ht(r, e.value, e.value.length - 1)
    ? 0
    : 1;
}
function ns(e) {
...
function Ul(e, t, r) {
  if (e === null) return 0;
  let n = ze(e.value, 0);
  return (!(n === e.value.length) && !ts(e.value, n)) || Ht(r, e.value, n)
    ? 0
    : 1;
}
function Hl(e, t, r) {
  ...
  for (; n < e.value.length; n++) if (!j(le(e.value, n))) return 0;
  return Ht(r, e.value, n) ? 0 : 1;
}
var Gl = {
    "ident-token": N(1),
    "function-token": N(2),
  ...
  Kt = class {
    ...
    findWsEnd(t) {
      for (; t < this.str.length; t++) {
        ...
        if (r !== oc && r !== nc && r !== ic && r !== sc && r !== rc) break;
      }
      return t;
    }
    substringToPos(t) {
    ...
    error(t) {
      throw new Yt(t, this.str, this.pos);
    }
    scanSpaces() {
    ...
    scanWord() {
      ...
      for (; t < this.str.length; t++) {
        let r = this.str.charCodeAt(t);
        if (r >= 128 || os[r] === 0) break;
      }
      return (
        this.pos === t && this.error("Expect a keyword"), this.substringToPos(t)
      );
    }
    scanNumber() {
      let t = this.pos;
      ...
      return (
        this.pos === t && this.error("Expect a number"), this.substringToPos(t)
      );
    }
    scanString() {
...
function Te(e, t) {
  ...
  return r !== null
    ? ((r.term = t),
      e.charCode() === Nr && e.charCodeAt(e.pos - 1) === Or ? Te(e, r) : r)
    : t;
}
function Pr(e) {
  let t = e.peek();
  return t === "" ? null : Te(e, { type: "Token", value: t });
}
function dc(e) {
  let t;
  return (
...
function gc(e) {
  ...
  return (
    e.eat(ft),
    e.charCode() === as && (e.peek(), (n = -1)),
    n == -1 && e.charCode() === us
      ? e.peek()
      : ((t = n * Number(e.scanNumber(e))),
        e.isNameCharCode() && (t += e.scanWord())),
    e.skipWs(),
    e.eat(Fr),
    e.skipWs(),
    e.charCode() === us
      ...
      : ((n = 1),
        e.charCode() === as && (e.peek(), (n = -1)),
        (r = n * Number(e.scanNumber(e))),
        e.isNameCharCode() && (r += e.scanWord())),
    e.eat(dt),
...
function bc(e) {
  let t,
    r = null;
  if ((e.eat(Rr), (t = e.scanWord()), t === "boolean-expr")) {
    e.eat(ft);
    let n = Mr(e, dt);
    return (
      e.eat(dt),
      e.eat(Ir),
      Te(e, { type: "Boolean", term: n.terms.length === 1 ? n.terms[0] : n })
    );
  }
  return (
    e.charCode() === fs &&
      e.nextCharCode() === hc &&
      ((e.pos += 2), (t += "()")),
    e.charCodeAt(e.findWsEnd(e.pos)) === ft && (e.skipWs(), (r = gc(e))),
    e.eat(Ir),
    Te(e, { type: "Type", name: t, opts: r })
  );
}
function xc(e) {
  let t = e.scanWord();
  return e.charCode() === fs
    ? (e.pos++, { type: "Function", name: t })
    : Te(e, { type: "Keyword", name: t });
}
function yc(e, t) {
  function r(i, o) {
    return {
  ...
  let n;
  for (t = Object.keys(t).sort((i, o) => ps[i] - ps[o]); t.length > 0; ) {
    n = t.shift();
    let i = 0,
      o = 0;
    for (; i < e.length; i++) {
      ...
      a.type === "Combinator" &&
        (a.value === n
          ? (o === -1 && (o = i - 1), e.splice(i, 1), i--)
          : (o !== -1 &&
              i - o > 1 &&
              (e.splice(o, i - o, r(e.slice(o, i), n)), (i = o + 1)),
            (o = -1)));
    }
...
function kc(e, t) {
  ...
  return (
    ...
    e.eat(dt),
    (r.explicit = !0),
    e.charCode() === ms && (e.pos++, (r.disallowEmpty = !0)),
    r
  );
}
function wc(e, t) {
  ...
  switch (r) {
    ...
    case ft:
      return Te(e, kc(e, t));
    case Rr:
      return e.nextCharCode() === Vt ? dc(e) : bc(e);
    case ls:
      return {
        type: "Combinator",
        value: e.substringToPos(e.pos + (e.nextCharCode() === ls ? 2 : 1)),
      };
    case ss:
      return e.pos++, e.eat(ss), { type: "Combinator", value: "&&" };
    case Fr:
      return e.pos++, { type: "Comma" };
    case Vt:
      return Te(e, { type: "String", value: e.scanString() });
    case pc:
    case ac:
    case lc:
    case uc:
    case cc:
      return { type: "Spaces", value: e.scanSpaces() };
    case mc:
      return (
        (r = e.nextCharCode()),
        e.isNameCharCode(r)
          ? (e.pos++, { type: "AtKeyword", name: e.scanWord() })
          : Pr(e)
      );
    case ds:
    case Or:
    ...
    case ms:
      break;
    case Qt:
      if (((r = e.nextCharCode()), r < 48 || r > 57)) return Pr(e);
      break;
    default:
      return e.isNameCharCode(r) ? xc(e) : Pr(e);
  }
}
function Qe(e) {
  let t = new Kt(e),
...
function Sc(e) {
  let t = [];
  return (
    Se(e, (r, n, i) => t.push({ type: r, value: e.slice(n, i), node: null })), t
  );
}
function xs(e, t) {
  return typeof e == "string" ? Sc(e) : t.generate(e, vc);
}
var A = { type: "Match" },
  z = { type: "Mismatch" },
  $t = { type: "DisallowEmpty" },
  Cc = 40,
  Tc = 41;
function J(e, t, r) {
  return (t === A && r === z) || (e === A && t === A && r === A)
    ? e
    : (e.type === "If" &&
        e.else === z &&
        t === A &&
...
function ks(e) {
  return (
    e.length > 2 &&
    e.charCodeAt(e.length - 2) === Cc &&
    e.charCodeAt(e.length - 1) === Tc
  );
}
function ys(e) {
  return (
...
function bt(e, t, r = new Set()) {
  if (!r.has(e))
    switch ((r.add(e), e.type)) {
      case "If":
        (e.match = bt(e.match, t, r)),
          (e.then = bt(e.then, t, r)),
          (e.else = bt(e.else, t, r));
        break;
      case "Type":
        return t[e.name] || e;
    }
      ...
      for (let o = t.length - 1; o >= 0; o--) {
        ...
        if (
          ...
          (i === null &&
            ...
            (n = J({ type: "Enum", map: i }, A, n))),
          i !== null)
        ) {
          let u = (ks(a.name) ? a.name.slice(0, -1) : a.name).toLowerCase();
          if (!(u in i)) {
            i[u] = a;
            continue;
          }
...
function Ac(e) {
  ...
  if (e.max === 0)
    (r = J(r, $t, z)),
      (t = J(r, null, z)),
      (t.then = J(A, A, t)),
      e.comma && (t.then.else = J({ type: "Comma", syntax: e }, t, z));
  else
    for (let n = e.min || 1; n <= e.max; n++)
      e.comma && t !== A && (t = J({ type: "Comma", syntax: e }, t, z)),
        (t = J(r, J(A, A, t), z));
  if (e.min === 0) t = J(A, A, t);
  else
...
function Xe(e) {
  ...
  switch (e.type) {
    case "Group": {
      let t = Br(e.combinator, e.terms.map(Xe), !1);
      return e.disallowEmpty && (t = J(t, $t, z)), t;
    }
    case "Multiplier":
      return Ac(e);
    case "Boolean": {
      ...
      return (
        bt(n, { "!term": t, "!self": r }), bt(r, { "!boolean-group": n }), r
      );
    }
    case "Type":
    case "Property":
...
function xt(e, t) {
  return (
    ...
    { type: "MatchGraph", match: Xe(e), syntax: t || null, source: e }
  );
}
...
function Oc(e, t, r) {
  ...
  function a(se) {
    m = { nextState: se, matchStack: O, syntaxStack: h, prev: m };
  }
  function u(se) {
    f = o(se, f);
  }
  function l() {
    (O = { type: Ec, syntax: t.syntax, token: C, prev: O }),
      n(),
      (w = null),
      M > ve && (ve = M);
  }
  function s() {
    (h = {
      ...
      (O = { type: Wr, syntax: t.syntax, token: O.token, prev: O });
  }
  function c() {
    O.type === Wr
      ? (O = O.prev)
      : (O = { type: As, syntax: h.syntax, token: O.token, prev: O }),
      (h = h.prev);
  }
  let h = null,
    m = null,
    ...
    M = -1,
    ve = 0,
    O = { type: Lc, syntax: null, token: null, prev: null };
  for (n(); G === null && ++ee < Ss; )
    switch (t.type) {
      case "Match":
        if (m === null) {
          if (
            C !== null &&
            (M !== e.length - 1 || (C.value !== "\\0" && C.value !== "\\9"))
          ) {
            t = z;
            break;
          }
      ...
      case "MatchGraph":
        ...
        break;
      case "If":
        t.else !== z && u(t.else), t.then !== A && a(t.then), (t = t.match);
        break;
      case "MatchOnce":
      ...
      case "MatchOnceBuffer": {
        ...
        for (; t.index < Q.length; t.index++) {
          ...
          if (!(t.mask & X)) {
            u(t),
              a({ type: "AddMatchOnce", syntax: t.syntax, mask: t.mask | X }),
              (t = Q[t.index++]);
            break;
          }
        }
      ...
      case "Enum":
        ...
        break;
      case "Generic": {
        let Q = h !== null ? h.opts : null,
          X = M + Math.floor(t.fn(C, i, Q));
        if (!isNaN(X) && X > M) {
          for (; M < X; ) l();
          t = A;
        } else t = z;
      ...
      case "Comma":
        C !== null && C.type === 18
          ? Cs(O.token)
            ? (t = z)
            : (l(), (t = Ts(C) ? z : A))
          : (t = Cs(O.token) || Ts(C) ? A : z);
        break;
      case "String":
        let se = "",
          ge = M;
        for (; ge < e.length && se.length < t.value.length; ge++)
          se += e[ge].value;
        if (_r(se, t.value)) {
          for (; M < ge; ) l();
          t = A;
  ...
  switch (((Ic += ee), G)) {
    case null:
      console.warn("[csstree-match] BREAK after " + Ss + " iterations"),
        (G = Pc),
        (O = null);
      break;
    case vs:
  ...
  return { tokens: e, reason: G, iterations: ee, match: O, longestMatch: ve };
}
function jr(e, t, r) {
  let n = Oc(e, t, r || {});
  if (n.match === null) return n;
  let i = n.match,
    o = (n.match = { syntax: t.syntax || null, match: [] }),
    a = [o];
  for (i = Dc(i).prev; i !== null; ) {
    switch (i.type) {
      case Wr:
...
function Ls(e) {
  function t(i) {
    return i === null
      ? !1
      : i.type === "Type" || i.type === "Property" || i.type === "Keyword";
  }
  function r(i) {
    if (Array.isArray(i.match)) {
      for (let o = 0; o < i.match.length; o++)
        if (r(i.match[o])) return t(i.syntax) && n.unshift(i.syntax), !0;
...
function Es(e) {
  return "node" in e ? e.node : Es(e.match[0]);
}
function zs(e) {
  return "node" in e ? e.node : zs(e.match[e.match.length - 1]);
}
    ...
    if (u.syntax !== null && u.syntax.type === n && u.syntax.name === i) {
      ...
      e.syntax.walk(t, function (c, h, m) {
        if (c === l) {
          let f = new Z();
          do {
            if ((f.appendData(h.data), h.data === s)) break;
            h = h.next;
          } while (h !== null);
          a.push({ parent: m, nodes: f });
        }
      });
    }
...
var { hasOwnProperty: yt } = Object.prototype;
function Gr(e) {
  return typeof e == "number" && isFinite(e) && Math.floor(e) === e && e >= 0;
}
function Ps(e) {
  return !!e && Gr(e.offset) && Gr(e.line) && Gr(e.column);
}
function Bc(e, t) {
  return function (n, i) {
    if (!n || n.constructor !== Object)
      return i(n, "Type of node should be an Object");
    for (let o in n) {
      let a = !0;
      if (yt.call(n, o) !== !1) {
        if (o === "type")
          n.type !== e &&
            i(n, "Wrong node type `" + n.type + "`, expected `" + e + "`");
        else if (o === "loc") {
          if (n.loc === null) continue;
          if (n.loc && n.loc.constructor === Object)
            if (typeof n.loc.source != "string") o += ".source";
            else if (!Ps(n.loc.start)) o += ".start";
            else if (!Ps(n.loc.end)) o += ".end";
            else continue;
          a = !1;
          ...
          for (let u = 0; !a && u < t[o].length; u++) {
            ...
            switch (l) {
              ...
              default:
                typeof l == "string"
                  ? (a = n[o] && n[o].type === l)
                  : Array.isArray(l) && (a = n[o] instanceof Z);
            }
          }
        } else i(n, "Unknown field `" + o + "` for " + e + " node type");
        a || i(n, "Bad value for `" + e + "." + o + "`");
      }
    }
    for (let o in t)
      yt.call(t, o) &&
        yt.call(n, o) === !1 &&
        i(n, "Field `" + e + "." + o + "` is missed");
  };
}
function Is(e, t) {
  let r = [];
  for (let n = 0; n < e.length; n++) {
    ...
    else if (Array.isArray(i)) r.push("List<" + (Is(i, t) || "any") + ">");
    else
      throw new Error(
        "Wrong value `" + i + "` in `" + t + "` structure definition"
      );
  }
  return r.join(" | ");
}
function _c(e, t) {
  let r = t.structure,
    ...
    i = { type: '"' + e + '"' };
  for (let o in r) {
    if (yt.call(r, o) === !1) continue;
    let a = (n[o] = Array.isArray(r[o]) ? r[o].slice() : [r[o]]);
    i[o] = Is(a, e + "." + o);
  }
  return { docs: i, check: Bc(e, n) };
}
function Ds(e) {
  let t = {};
  if (e.node) {
...
function Yr(e, t, r) {
  let n = {};
  for (let i in e)
    e[i].syntax && (n[i] = r ? e[i].syntax : Ne(e[i].syntax, { compact: t }));
  return n;
}
function Wc(e, t, r) {
  let n = {};
  for (let [i, o] of Object.entries(e))
    n[i] = {
      prelude:
        o.prelude &&
        (r ? o.prelude.syntax : Ne(o.prelude.syntax, { compact: t })),
      descriptors: o.descriptors && Yr(o.descriptors, t, r),
    };
  return n;
}
function jc(e) {
...
function ce(e, t, r) {
  return { matched: e, iterations: r, error: t, ...Ur };
}
function $e(e, t, r, n) {
  let i = xs(r, e.syntax),
    o;
  return jc(i)
    ...
    : (n && (o = jr(i, e.cssWideKeywordsSyntax, e)),
      (!n || !o.match) && ((o = jr(i, t.match, e)), !o.match)
        ? ce(null, new Xo(o.reason, t.syntax, r, o), o.iterations)
        : ce(o.match, null, o.iterations));
}
var Ze = class {
  constructor(t, r, n) {
    if (
      ((this.cssWideKeywords = Ke),
      (this.syntax = r),
      (this.generic = !1),
      (this.units = { ...Gt }),
      ...
      (this.structure = n || Ds(t)),
      t)
    ) {
      if (
        (t.cssWideKeywords && (this.cssWideKeywords = t.cssWideKeywords),
        t.units)
      )
        for (let i of Object.keys(Gt))
          Array.isArray(t.units[i]) && (this.units[i] = t.units[i]);
      if (t.types)
        for (let [i, o] of Object.entries(t.types)) this.addType_(i, o);
      if (t.generic) {
        this.generic = !0;
        for (let [i, o] of Object.entries(is(this.units))) this.addType_(i, o);
      }
      if (t.atrules)
        for (let [i, o] of Object.entries(t.atrules)) this.addAtrule_(i, o);
      if (t.properties)
        for (let [i, o] of Object.entries(t.properties))
          this.addProperty_(i, o);
    }
    this.cssWideKeywordsSyntax = xt(this.cssWideKeywords.join(" |  "));
  }
  checkStructure(t) {
    function r(o, a) {
    ...
    return (
      this.syntax.walk(t, function (o) {
        n.hasOwnProperty(o.type)
          ? n[o.type].check(o, r)
          : r(o, "Unknown node type `" + o.type + "`");
      }),
      i.length ? i : !1
    );
  }
      ...
      typeof t == "function"
        ...
        : (typeof t == "string"
            ? Object.defineProperty(a, "syntax", {
                get() {
                  return (
                    Object.defineProperty(a, "syntax", { value: Qe(t) }),
                    a.syntax
                  );
                },
              })
          ...
          Object.defineProperty(a, "match", {
            get() {
              return (
                Object.defineProperty(a, "match", { value: xt(a.syntax, o) }),
                a.match
              );
            },
          }),
          r === "Property" &&
            Object.defineProperty(a, "matchRef", {
              get() {
                let u = a.syntax,
                  l = qc(u) ? xt({ ...u, terms: [u.terms[0].term] }, o) : null;
                return Object.defineProperty(a, "matchRef", { value: l }), l;
              },
            })),
      a
    );
  ...
  checkAtruleName(t) {
    if (!this.getAtrule(t)) return new Ge("Unknown at-rule", "@" + t);
  }
  checkAtrulePrelude(t, r) {
    ...
    if (i.prelude && !r && !$e(this, i.prelude, "", !1).matched)
  ...
  checkAtruleDescriptorName(t, r) {
    ...
    if (!i.descriptors[o.name] && !i.descriptors[o.basename])
      return new Ge("Unknown at-rule descriptor", r);
  }
  checkPropertyName(t) {
    if (!this.getProperty(t)) return new Ge("Unknown property", t);
  }
  matchAtrulePrelude(t, r) {
    let n = this.checkAtrulePrelude(t, r);
    if (n) return ce(null, n);
    let i = this.getAtrule(t);
    return i.prelude ? $e(this, i.prelude, r || "", !1) : ce(null, null);
  }
  matchAtruleDescriptor(t, r, n) {
    let i = this.checkAtruleDescriptorName(t, r);
    if (i) return ce(null, i);
    let o = this.getAtrule(t),
      a = jt(r);
    return $e(this, o.descriptors[a.name] || o.descriptors[a.basename], n, !1);
  }
  matchDeclaration(t) {
  ...
  matchProperty(t, r) {
    ...
    return n ? ce(null, n) : $e(this, this.getProperty(t), r, !0);
  }
  matchType(t, r) {
    let n = this.getType(t);
    return n ? $e(this, n, r, !1) : ce(null, new Ge("Unknown type", t));
  }
  match(t, r) {
    return typeof t != "string" && (!t || !t.type)
      ? ce(null, new Ge("Bad syntax"))
      : ((typeof t == "string" || !t.match) &&
          (t = this.createDescriptor(t, "Type", "anonymous")),
        $e(this, t, r, !1));
  }
  findValueFragments(t, r, n, i) {
    return Hr(this, r, this.matchProperty(t, r), n, i);
  }
  findDeclarationValueFragments(t, r, n) {
    return Hr(this, t.value, this.matchDeclaration(t), r, n);
  }
  ...
  validate() {
      ...
      c.set(s, !1),
        h.syntax !== null &&
          Xt(
            h.syntax,
            function (m) {
              if (m.type !== "Type" && m.type !== "Property") return;
              let f = m.type === "Type" ? l.types : l.properties,
                w = m.type === "Type" ? i : o;
              hasOwnProperty.call(f, m.name)
                ? r(l, m.name, w, f[m.name]) &&
                  (n.push(
                    `${t(s, c === i)} used broken syntax definition ${t(
                      m.name,
                      m.type === "Type"
                    )}`
                  ),
                  c.set(s, !0))
                : (n.push(
                    `${t(s, c === i)} used missed syntax definition ${t(
                      m.name,
                      m.type === "Type"
                    )}`
                  ),
    ...
    let n = [],
      i = new Map(),
      o = new Map();
    for (let l in this.types) r(this, l, i, this.types[l]);
    for (let l in this.properties) r(this, l, o, this.properties[l]);
    let a = [...i.keys()].filter((l) => i.get(l)),
      u = [...o.keys()].filter((l) => o.get(l));
    return a.length || u.length ? { errors: n, types: a, properties: u } : null;
  }
  dump(t, r) {
    return {
    ...
    switch (n) {
      ...
      case "atrules":
        ...
        for (let [o, a] of Object.entries(i)) {
          ...
          if (a) {
            l.prelude = a.prelude
              ? Kr(l.prelude, a.prelude)
              : l.prelude || null;
            for (let [s, c] of Object.entries(a.descriptors || {}))
              l.descriptors[s] = c ? Kr(l.descriptors[s], c) : null;
      ...
      case "properties":
        r[n] = { ...e[n] };
        for (let [o, a] of Object.entries(i)) r[n][o] = Kr(r[n][o], a);
        break;
      case "scope":
      case "features":
        r[n] = { ...e[n] };
        for (let [o, a] of Object.entries(i)) r[n][o] = { ...r[n][o], ...a };
        break;
      case "parseContext":
        r[n] = { ...e[n], ...i };
        break;
      ...
      case "node":
        r[n] = {
          ...e[n],
          ...Ns(i, ["name", "structure", "parse", "generate", "walkContext"]),
        };
        break;
    }
  return r;
...
function Os(e) {
  let t = bo(e),
    r = Vo(e),
    n = qo(e),
    { fromPlainObject: i, toPlainObject: o } = Uo(r),
    a = {
      lexer: null,
      createLexer: (u) => new Ze(u, a, a.lexer.structure),
      tokenize: Se,
      parse: t,
      generate: n,
      walk: r,
      ...
      fork(u) {
        let l = kt({}, e);
        return Os(typeof u == "function" ? u(l) : kt(l, u));
      },
    };
  return (
    (a.lexer = new Ze(
...
function Qr() {
  ...
  if (r !== 10)
    if (this.isDelim(de, e) || this.isDelim(re, e)) {
      t = this.isDelim(de, e) ? de : re;
      do r = this.lookupType(++e);
      while (r === 13 || r === 25);
      r !== 10 && (this.skip(e), Je.call(this, Oe));
    } else return null;
  return (
    e > 0 && this.skip(e),
    t === 0 &&
      ((r = this.charCodeAt(this.tokenStart)),
      r !== de && r !== re && this.error("Number sign is expected")),
    Je.call(this, t !== 0),
    t === re ? "-" + this.consume(10) : this.consume(10)
  );
}
var Hc = "AnPlusB",
  Gc = { a: [String, null], b: [String, null] };
function Xr() {
  let e = this.tokenStart,
    t = null,
    r = null;
  if (this.tokenType === 10) Je.call(this, Uc), (r = this.consume(10));
  else if (this.tokenType === 1 && this.cmpChar(this.tokenStart, re))
    switch (
      ((t = "-1"), Le.call(this, 1, Zt), this.tokenEnd - this.tokenStart)
    ) {
      case 2:
    ...
    this.tokenType === 1 ||
    (this.isDelim(de) && this.lookupType(1) === 1)
  ) {
    let n = 0;
    switch (
      ((t = "1"),
      this.isDelim(de) && ((n = 1), this.next()),
      Le.call(this, 0, Zt),
    ...
    let n = this.charCodeAt(this.tokenStart),
      i = n === de || n === re,
      o = this.tokenStart + i;
    for (; o < this.tokenEnd && j(this.charCodeAt(o)); o++);
    o === this.tokenStart + i &&
      this.error("Integer is expected", this.tokenStart + i),
      Le.call(this, o - this.tokenStart, Zt),
      (t = this.substring(e, o)),
      o + 1 === this.tokenEnd
        ? (this.next(), (r = Qr.call(this)))
        : (Le.call(this, o - this.tokenStart + 1, re),
          o + 2 === this.tokenEnd
            ? (this.next(),
              this.skipSC(),
              Je.call(this, Oe),
              (r = "-" + this.consume(10)))
            : (Jt.call(this, o - this.tokenStart + 2, Oe),
              this.next(),
              (r = this.substrToCursor(o + 1))));
  } else this.error();
  return (
    t !== null && t.charCodeAt(0) === de && (t = t.substr(1)),
    r !== null && r.charCodeAt(0) === de && (r = r.substr(1)),
  ...
  switch (
    ...
    this.eof === !1 &&
      ...
      (this.parseAtrulePrelude
        ? (i = this.parseWithFallback(this.AtrulePrelude.bind(this, r, e), Rs))
        : (i = Rs.call(this, this.tokenIndex)),
      this.skipSC()),
    this.tokenType)
  ) {
    case 17:
    ...
    case 23:
      ...
      typeof this.atrule[n].block == "function"
        ? (o = this.atrule[n].block.call(this, e))
...
function su() {
  ...
  return (
    ...
    this.next(),
    t !== er &&
      (this.isDelim(er) || this.error("Equal sign is expected"), this.next()),
    this.substrToCursor(e)
  );
}
var au = "AttributeSelector",
  lu = {
    name: "Identifier",
    matcher: [String, null],
  ...
  return (
    ...
    this.tokenType !== 20 &&
      (this.tokenType !== 1 &&
        ...
        this.skipSC()),
      this.tokenType === 1 && ((i = this.consume(1)), this.skipSC())),
    this.eat(20),
    {
...
function Bs() {
  return this.parseWithFallback(this.Rule, Ws);
}
function _s() {
  return this.Raw(this.consumeUntilSemicolonIncluded, !0);
}
function pu() {
  if (this.tokenType === 17) return _s.call(this, this.tokenIndex);
  let e = this.parseWithFallback(this.Declaration, _s);
  return this.tokenType === 17 && this.next(), e;
}
var hu = "Block",
  mu = "block",
  fu = { children: [["Atrule", "Rule", "Declaration"]] };
function sn(e) {
  let t = e ? pu : Bs,
    r = this.tokenStart,
    n = this.createList();
  ...
  e: for (; !this.eof; )
    switch (this.tokenType) {
      ...
      case 25:
        ...
        break;
      case 3:
        n.push(this.parseWithFallback(this.Atrule.bind(this, e), Ws));
        break;
      default:
        e && this.isDelim(uu) ? n.push(Bs.call(this)) : n.push(t.call(this));
    }
  return (
    ...
    case 9:
      switch (this.charCodeAt(this.tokenStart)) {
        ...
        case Iu:
          ...
          break;
        case js:
          this.next(), this.eatIdent("deep"), this.eatDelim(js);
          break;
        default:
...
function xn() {
  ...
  return (
    this.eat(25),
    t - e + 2 >= 2 &&
      this.charCodeAt(t - 2) === Fu &&
      this.charCodeAt(t - 1) === Ru &&
      (t -= 2),
    {
      type: "Comment",
      loc: this.getLocation(e, this.tokenStart),
...
function qs(e) {
  return this.lookupTypeNonSC(1) === 1 && Wu.has(this.lookupTypeNonSC(2))
    ? this.Feature(e)
    : this.FeatureRange(e);
}
var Uu = {
...
function kn(e = "media") {
  ...
  return (
    t.isEmpty && this.error("Condition is expected"),
    {
      type: "Condition",
...
function vn() {
  ...
  if (
    (n || this.skipSC(),
    i
      ? (u = this.parseWithFallback(Zu, o))
      : (u = o.call(this, this.tokenIndex)),
  ...
  return (
    this.isDelim(Hs) && ((a = ip.call(this)), this.skipSC()),
    this.eof === !1 &&
      this.tokenType !== 17 &&
  ...
  if (this.tokenType === 9)
    switch (this.charCodeAt(this.tokenStart)) {
      ...
      case Ku:
        ...
        break;
      case Us:
        this.next(), this.isDelim(Us) && this.next();
        break;
    }
  return (
...
var sp = "DeclarationList",
  ap = { children: [["Declaration", "Atrule", "Rule"]] };
function Tn() {
  ...
  for (; !this.eof; )
    switch (this.tokenType) {
      ...
      case 17:
        ...
        break;
      case 3:
        e.push(this.parseWithFallback(this.Atrule.bind(this, !0), Cn));
        break;
      default:
        this.isDelim(op)
          ? e.push(this.parseWithFallback(this.Rule, Cn))
          : e.push(this.parseWithFallback(this.Declaration, Cn));
    }
  return {
      ...
      case 2:
        n = this.parseWithFallback(
          () => {
            ...
            return this.skipSC(), this.isDelim(hp) && this.error(), i;
          },
          () => this.Ratio()
        );
        break;
...
var gp = "FeatureFunction",
  bp = { kind: String, feature: String, value: ["Declaration", "Selector"] };
function xp(e, t) {
...
function In(e = "unknown") {
  let t = this.tokenStart,
    ...
    n = xp.call(this, e, r.toLowerCase());
  this.skipSC();
...
function Nn() {
  switch ((this.skipSC(), this.tokenType)) {
    case 10:
      return this.isDelim(Gs, this.lookupOffsetNonSC(1))
        ? this.Ratio()
        : this.Number();
    case 12:
    ...
    case 2:
      return this.parseWithFallback(
        () => {
          ...
          return this.skipSC(), this.isDelim(Gs) && this.error(), e;
        },
        () => this.Ratio()
      );
    default:
...
function Ks(e) {
  if ((this.skipSC(), this.isDelim(kp) || this.isDelim(wp))) {
    let t = this.source[this.tokenStart];
    return this.next(), this.isDelim(Ys) ? (this.next(), t + "=") : t;
  }
  if (this.isDelim(Ys)) return "=";
...
function On(e = "unknown") {
  ...
  let r = Nn.call(this),
    n = Ks.call(this, r.type === "Identifier"),
    i = Nn.call(this),
    o = null,
    a = null;
  return (
    this.lookupNonWSType(0) !== 22 &&
      ((o = Ks.call(this)), (a = Nn.call(this))),
    this.skipSC(),
    this.eat(22),
    {
      type: "FeatureRange",
...
var zp = "GeneralEnclosed",
  Pp = { kind: String, function: [String, null], children: [[]] };
function Bn(e) {
  let t = this.tokenStart,
    r = null;
...
function Yn() {
  let e = this.tokenStart,
    t = this.consume(1);
  for (; this.isDelim(qp); ) this.eat(9), (t += "." + this.consume(1));
  return { type: "Layer", loc: this.getLocation(e, this.tokenStart), name: t };
}
function Gp(e) {
  this.tokenize(e.name);
}
...
function Vn() {
  ...
  for (
    this.skipSC();
    !this.eof && (e.push(this.Layer()), this.lookupTypeNonSC(0) === 18);

  )
    this.skipSC(), this.next(), this.skipSC();
  return { type: "LayerList", loc: this.getLocationFromList(e), children: e };
}
function Vp(e) {
...
function Xn() {
  ...
  if ((this.skipSC(), this.tokenType === 1 && this.lookupTypeNonSC(1) !== 21)) {
    ...
    switch (
      (o === "not" || o === "only"
        ? (this.skipSC(), (t = o), (r = this.consume(1)))
        : (r = i),
      this.lookupTypeNonSC(0))
    ) {
      case 1: {
...
var Zp = "MediaQueryList",
  Jp = { children: [["MediaQuery"]] };
function Zn() {
  let e = this.createList();
  for (
    this.skipSC();
...
var oh = "Nth",
  sh = { nth: ["AnPlusB", "Identifier"], selector: ["SelectorList", null] };
function ri() {
  this.skipSC();
  let e = this.tokenStart,
    t = e,
...
var kh = "PseudoClassSelector",
  wh = "function",
  vh = { name: String, children: [["Raw"], null] };
function hi() {
  let e = this.tokenStart,
    t = null,
    r,
...
var Ch = "PseudoElementSelector",
  Th = "function",
  Ah = { name: String, children: [["Raw"], null] };
function fi() {
  let e = this.tokenStart,
    t = null,
    r,
...
var Eh = "Ratio",
  zh = { left: ["Number", "Function"], right: ["Number", "Function", null] };
function gi() {
  let e = this.tokenStart,
    t = Qs.call(this),
    r = null;
  return (
    this.skipSC(),
    this.isDelim(Vs) && (this.eatDelim(Vs), (r = Qs.call(this))),
    {
      type: "Ratio",
      loc: this.getLocation(e, this.tokenStart),
      left: t,
...
function xi(e, t) {
  ...
  return (
    ...
    t && this.tokenStart > r ? (n = Ih.call(this)) : (n = this.tokenStart),
    { type: "Raw", loc: this.getLocation(r, n), value: this.substring(r, n) }
  );
}
function Oh(e) {
  this.tokenize(e.value);
...
var Rh = "Rule",
  Mh = "rule",
  Bh = { prelude: ["SelectorList", "Raw"], block: ["Block"] };
function ki() {
  let e = this.tokenIndex,
    t = this.tokenStart,
    r,
  ...
  return (
    this.parseRulePrelude
      ? (r = this.parseWithFallback(Fh, Xs))
      : (r = Xs.call(this, e)),
    (n = this.Block(!0)),
    {
      type: "Rule",
...
function vi() {
  ...
  return (
    this.tokenType === 21 &&
      (this.next(),
      this.skipSC(),
      (e = this.parseWithFallback(this.SelectorList, () => this.Raw(!1, !0))),
      this.skipSC(),
      this.eat(22)),
...
function wt(e) {
  ...
  for (let a = n; a <= i; a++) {
    ...
    if (u === Ei) {
      ...
      if (((u = e.charCodeAt(++a)), $(Ei, u))) {
        let l = a - 1,
          s = ae(e, l);
        (a = s - 1), (o += We(e.substring(l + 1, s)));
...
function zi(e, t) {
  ...
  for (let a = 0; a < e.length; a++) {
    ...
    u === n || u === Ei
      ? ((i += "\\" + e.charAt(a)), (o = !1))
      : (o && (te(u) || pe(u)) && (i += " "), (i += e.charAt(a)), (o = !1));
  }
  return r + i + r;
}
var Xh = "String",
...
function Ii() {
  return {
    type: "String",
    loc: this.getLocation(this.tokenStart, this.tokenEnd),
    value: wt(this.consume(5)),
  };
}
function Zh(e) {
  this.token(5, zi(e.value));
}
var Oi = {};
x(Oi, {
  generate: () => nm,
...
var em = "StyleSheet",
  tm = "stylesheet",
  rm = { children: [["Comment", "CDO", "CDC", "Atrule", "Rule", "Raw"]] };
function Ni() {
  let e = this.tokenStart,
    t = this.createList(),
    r;
  for (; !this.eof; ) {
    switch (this.tokenType) {
      case 13:
        ...
        continue;
      case 25:
        if (this.charCodeAt(this.tokenStart + 2) !== Jh) {
          this.next();
          continue;
        }
        r = this.Comment();
      ...
      case 15:
        ...
        break;
      case 3:
        r = this.parseWithFallback(this.Atrule, Js);
        break;
      default:
        r = this.parseWithFallback(this.Rule, Js);
    }
    t.push(r);
  }
  return {
...
function Bi() {
  ...
  return (
    this.isDelim(ea)
      ? (this.next(), Mi.call(this))
      : (Mi.call(this), this.isDelim(ea) && (this.next(), Mi.call(this))),
    {
      type: "TypeSelector",
      loc: this.getLocation(e, this.tokenStart),
      name: this.substrToCursor(e),
...
function vt(e, t) {
  ...
  for (let n = this.tokenStart + e; n < this.tokenEnd; n++) {
    ...
    if (i === ra && t && r !== 0) return vt.call(this, e + r + 1, !1), -1;
    te(i) ||
      this.error(
        t && r !== 0
...
function pm(e) {
  this.charCodeAt(this.tokenStart) !== e &&
    this.error((e === ta ? "Plus sign" : "Hyphen minus") + " is expected");
}
function hm() {
  let e = 0;
  switch (this.tokenType) {
    case 10:
      if (((e = vt.call(this, 1, !0)), this.isDelim(Wi))) {
        tr.call(this, 6 - e);
        break;
      }
      if (this.tokenType === 12 || this.tokenType === 10) {
        pm.call(this, ra), vt.call(this, 1, !1);
        break;
      }
      break;
    case 12:
      (e = vt.call(this, 1, !0)), e > 0 && tr.call(this, 6 - e);
      break;
    default:
      if ((this.eatDelim(ta), this.tokenType === 1)) {
        (e = vt.call(this, 0, !0)), e > 0 && tr.call(this, 6 - e);
        break;
      }
      if (this.isDelim(Wi)) {
...
function Hi(e) {
  ...
  for (let o = r; o <= n; o++) {
    ...
    if (a === Ui) {
      ...
      if (((a = e.charCodeAt(++o)), $(Ui, a))) {
        let u = o - 1,
          l = ae(e, u);
        (o = l - 1), (i += We(e.substring(u + 1, l)));
      } else a === 13 && e.charCodeAt(o + 1) === 10 && o++;
    } else i += e[o];
  }
  return i;
}
function Gi(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    ...
    i === gm || i === Ui || i === bm || i === xm || i === ym || i === na
      ? ((t += "\\" + e.charAt(n)), (r = !1))
      : (r && te(i) && (t += " "), (t += e.charAt(n)), (r = !1));
  }
  return "url(" + t + ")";
}
var km = "Url",
...
var Am = Object.freeze({ type: "WhiteSpace", loc: null, value: " " }),
  Lm = "WhiteSpace",
  Em = { value: String };
function $i() {
  return this.eat(13), Am;
}
function zm(e) {
  this.token(13, e.value);
}
var ia = { generic: !0, cssWideKeywords: Ke, ...Fs, node: St };
var Ji = {};
x(Ji, { AtrulePrelude: () => sa, Selector: () => la, Value: () => ha });
var Pm = 35,
  Im = 42,
  oa = 43,
  Dm = 45,
...
function Ct(e) {
  switch (this.tokenType) {
    ...
    case 7:
      return this.Url();
    case 1:
      return this.cmpChar(this.tokenStart, Om) &&
        this.cmpChar(this.tokenStart + 1, oa)
        ? this.UnicodeRange()
        : this.Identifier();
    case 9: {
      let t = this.charCodeAt(this.tokenStart);
      if (t === Nm || t === Im || t === oa || t === Dm) return this.Operator();
      t === Pm &&
...
function Hm() {
  switch (this.tokenType) {
    ...
    case 11:
      return this.Percentage();
    case 12:
      this.charCodeAt(this.tokenStart) === aa &&
...
var la = { onWhiteSpace: Um, getNode: Hm };
function ca() {
...
var ha = {
  getNode: Ct,
  onWhiteSpace(e, t) {
    pa(e) && (e.value = " " + e.value), pa(t.last) && (t.last.value += " ");
  },
  expression: ca,
  var: ua,
};
var Gm = new Set(["none", "and", "not", "or"]),
  ma = {
    parse: {
      prelude() {
        let e = this.createList();
        if (this.tokenType === 1) {
          ...
          Gm.has(t.toLowerCase()) || e.push(this.Identifier());
        }
...
var da = {
    layer() {
      this.skipSC();
      let e = this.createList(),
        t = eo.call(this, this.Layer);
      return (t.type !== "Raw" || t.value !== "") && e.push(t), e;
    },
    supports() {
      this.skipSC();
      let e = this.createList(),
        t = eo.call(this, this.Declaration, () =>
          eo.call(this, () => this.Condition("supports"))
        );
      return (t.type !== "Raw" || t.value !== "") && e.push(t), e;
    },
  },
...
function no(e) {
  ...
  for (let r of Object.keys(e)) {
    let n = e[r];
    n &&
      (Array.isArray(n) || n instanceof Z
        ? (n = n.map(no))
        : n.constructor === Object && (n = no(n))),
      (t[r] = n);
  }
  return t;
}
var Ia = {};
x(Ia, { decode: () => Vm, encode: () => Qm });
var Pa = 92;
function Vm(e) {
  let t = e.length - 1,
    r = "";
  for (let n = 0; n < e.length; n++) {
    ...
    if (i === Pa) {
      if (n === t) break;
      if (((i = e.charCodeAt(++n)), $(Pa, i))) {
        let o = n - 1,
          a = ae(e, o);
        (n = a - 1), (r += We(e.substring(o + 1, a)));
...
function Qm(e) {
  ...
  for (let r = 0; r < e.length; r++) {
    ...
    Me(n) ? (t += e.charAt(r)) : (t += "\\" + e.charAt(r));
  }
  return t;
}
var {
...
export {
  Ze as Lexer,
  Z as List,
  ot as OffsetToLocation,
  st as TokenStream,
  no as clone,
  Xx as createLexer,
  Vr as createSyntax,
  bs as definitionSyntax,
  Zx as find,
  ey as findAll,
  Jx as findLast,
  ny as fork,
  ry as fromPlainObject,
  Vx as generate,
  Ia as ident,
  qt as isCustomProperty,
  jt as keyword,
  Qx as lexer,
  Kx as parse,
  wr as property,
